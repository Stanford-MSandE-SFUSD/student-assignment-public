...
class School:
    ...
    def give_lowest_priority(self):
        ...
        if min(self.priority_storage) != self.lowest_priority_match[1]:
            raise ValueError(
    ...
    def remove_lowest_priority(self):
        min_priority = min(self.priority_storage)
        ...
        if len(self.priority_storage) == 0:
            ...
            new_min_prior = min(self.priority_storage)
...
class DeferredAcceptance:
    ...
    def run(self):
        unmatched_students = [
            i for i, student in enumerate(self.students) if not student.matched
        ]
        while unmatched_students:
            ...
            for i in unmatched_students:
                ...
                if student.check_exhausted(school_index) or priority < 0:
                    continue
