...
`scripts/settings/models_local.env` (placeholder paths for a full local run)
and `scripts/settings/models_test.env` (committed **small** test dataset in
`tests/fixtures/small_2223/`, exercised by `tests/test_full_pipeline.py`).