...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="<SFUSD_DATA_PATH>/Data/2025_cleaned_data/Cleaned_new/r1_filter_student_without_specialprogs_2324.csv",
    )
    parser.add_argument(
        "--schools",
        type=Path,
        help="Path to school CSV file.",
        default="<SFUSD_DATA_PATH>/Data/2025_cleaned_data/Cleaned_new/schools_rehauled_withMissionBay_2324.csv",
    )
    parser.add_argument(
        "--output",
        type=Path,
