...
Usage:
    ...
    python scripts/generate_policy_configs.py --template 13-0.25-2500_BG+no_reserves

Example:
    python scripts/generate_policy_configs.py \
        --zones-dir ./data/zones \
        --output-dir ./configs/policy_configs/generated \
        --template 13-0.25-2500_BG+no_reserves
"""
...
def generate_policy_config(
    zone_name: str,
    template: str = "13-0.25-2500_BG+no_reserves",
    guard_rails: int = -1,
    ...
    Args:
        ...
        guard_rails: Guard rails setting (-1 for no reserves, 0 for soft reserves).
